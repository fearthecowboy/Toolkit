...
namespace FearTheCowboy.Windows {
    ...
    public static class FilesystemExtensions {
        ...
        public static void MoveFileOverwrite(string sourceFile, string destinationFile) {
            Kernel32.MoveFileEx(sourceFile, destinationFile, MoveFileFlags.MOVEFILE_REPLACE_EXISTING);
        }

        public static void MoveFileAtNextBoot(string sourceFile, string destinationFile) {
            Kernel32.MoveFileEx(sourceFile, destinationFile, MoveFileFlags.MOVEFILE_DELAY_UNTIL_REBOOT);
        }
