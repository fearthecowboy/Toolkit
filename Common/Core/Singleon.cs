...
namespace FearTheCowboy.Common.Core {
    ...
    public static class Singleton<TResult> {
        ...
        public static TResult GetOrAdd(Func<TResult> newInstance, object primaryKey, params object[] keys) {
            return _singletons.GetOrAdd(SingletonExtensions.CreateHashCode(primaryKey, keys), newInstance);
        }

        public static TResult Get(object primaryKey, params object[] keys) {
            var hash = SingletonExtensions.CreateHashCode(primaryKey, keys);
        ...
        public static TResult AddOrSet(TResult value, object primaryKey, params object[] keys) {
            return Extensions.AddOrSet(_singletons, SingletonExtensions.CreateHashCode(primaryKey, keys), value);
        }

        public static void Remove(object primaryKey, params object[] keys) {
            _singletons.Remove(SingletonExtensions.CreateHashCode(primaryKey, keys));
        }
    }
    ...
    public static class SingletonExtensions {
        ...
        public static int CreateHashCode(object primaryKey, object[] keys) {
            ...
            var hash = Enumerable.Zip<int, object, int>(_seeds, keys, (prime, obj) => prime * (obj == null ? 0 : obj.GetHashCode())).Aggregate((accum, each) => accum + each) + primaryKey.GetHashCode();
